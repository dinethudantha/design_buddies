    ...
    <div className="app-shell">
      <header className="topbar d-flex align-items-center px-3">
        <div className="brand d-flex align-items-center">
          ...
          <h5 className="mb-0 ms-2">Gradient able</h5>
        </div>
        <div className="ms-auto d-flex align-items-center">
          <button className="btn btn-sm btn-outline-primary me-2">Help</button>
          <div className="avatar">O</div>
        </div>
      </header>

      <div className="d-flex">
        <aside className="sidebar bg-white p-3">
          <nav>
            <ul className="list-unstyled mb-0">
              <li className="mb-2 active"><a href="#" className="d-flex align-items-center"><i className="me-2 bi bi-speedometer2"></i> Dashboard</a></li>
              <li className="mb-2"><a href="#" className="d-flex align-items-center"><i className="me-2 bi bi-file-text"></i> Typography</a></li>
              <li className="mb-2"><a href="#" className="d-flex align-items-center"><i className="me-2 bi bi-palette"></i> Color</a></li>
              <li className="mb-2"><a href="#" className="d-flex align-items-center"><i className="me-2 bi bi-box"></i> Icons</a></li>
              <li className="mt-4"><a href="#" className="btn btn-primary w-100">Upgrade to Pro</a></li>
            </ul>
          </nav>
        </aside>
